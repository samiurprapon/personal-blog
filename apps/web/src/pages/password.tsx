					...
					<div className="col-xs-12 col-md-5 order-xs-1 order-md-2">
						<div className="passwordDisplay">
							...
							<div className="actions">
								<button onClick={copyToClipboard} title="Copy to clipboard" className="iconButton">
									<Copy />
								</button>
								<button onClick={generatePassword} title="Generate new password" className="iconButton">
									<RefreshCw />
								</button>
							</div>
						</div>

...
export class PasswordGenerator {
	...
	private constructor() {
		this.randomBytes = this.generateRandomBytes(PasswordGenerator.RANDOM_BATCH_SIZE);
	...
	generate(options: GenerateOptions = {}): string {
		...
		if (defaultedOptions.symbols) {
			pool += typeof defaultedOptions.symbols === 'string' ? defaultedOptions.symbols : PasswordGenerator.SYMBOLS;
		}

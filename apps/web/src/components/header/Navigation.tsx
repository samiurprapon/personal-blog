		...
		<nav className="navigation">
			<div className="navigation__container">
				...
				<div className="navigation__desktop-menu">
					...
					<button onClick={toggleTheme} className="navigation__theme-toggle" aria-label="Toggle theme">
						{getThemeIcon()}
					</button>
				...
				<div className="navigation__mobile-menu">
					...
					<button onClick={toggleMenu} className="navigation__mobile-menu-button" aria-expanded={isOpen}>

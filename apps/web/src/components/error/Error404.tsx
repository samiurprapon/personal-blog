const Error404 = () => (
	<svg viewBox='0 0 541.17206 328.45184' width='375' height='227.52' id='svg2' version='1.1'>
		...
		<defs id='defs6'>
			<pattern
				...
				id='Strips2_1'>
				<rect style={{ fill: 'var(--color-text)', stroke: 'none' }} x='0' y='-0.5' width='1' height='2' id='rect5419' />
			</pattern>
			<linearGradient id='linearGradient6096'>
				<stop id='stop6094' offset='0' style={{ stopColor: 'var(--color-background-hover)', stopOpacity: 1 }} />
			</linearGradient>
		</defs>

...
const GithubIssues: React.FC = () => {
	...
	return (
		<div>
			<div className="github-issues__scroll" id="topButton">
				<ChevronUp />
			</div>
					...
					>
						<div className="issue-card__content">
							...
							{issue.html_url.includes('/issues/') ? (
								<div className="icon">
									<svg className="icon__svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path
											strokeLinecap="round"
							...
							<div className="issue-info">
								<div className="issue-header">
									...
									<span className="time-ago">{formatDistanceToNow(new Date(issue.updated_at))} ago</span>
								</div>
								...
								<div className="labels">
									...
									{issue.labels.length > 3 && (
										<span className="label more-labels">+{issue.labels.length - 3} more</span>
									)}
								</div>
							</div>
						</div>
			...
			<div className="github-issues__scroll" id="bottomButton">
				<ChevronDown />
			</div>
		</div>
	);

...
const ScrollToTop = () => {
	...
	return (
		<div className={`scroll-up__container ${showScroll ? 'visible' : 'hidden'}`} onClick={scrollUp}>
			<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 9.887 5.943">
				<path
					id="Path_157"
					data-name="Path 157"

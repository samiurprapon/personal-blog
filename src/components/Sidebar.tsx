		...
		<div className="sidebar">
			...
			<div className="card">
				...
				<p className="card-description">
					Think of this blog as the stuff I can't say without awkward pauses.
					It's my thoughts, stories, and a peek into my world.
					<br />
				</p>
			...
			<div className="card">
				...
				<p className="card-description">
					Start wasting time—who says you can't be productive at
					procrastination?
				</p>
